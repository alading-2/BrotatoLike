...
INSERT OR REPLACE INTO unit_enemy(id, name, entity_type, death_type, visual_scene_path, health_bar_height, is_show_health_bar, pickup_range, exp_reward, detection_range, collision_team, collision_layer, collision_mask, collision_radius, max_hp, current_hp, armor, crit_rate, life_steal, contact_damage, contact_damage_interval, move_speed, acceleration, attack_damage, attack_range, attack_interval, attack_wind_up_time, attack_recovery_time, ai_is_enabled, ai_attack_range, spawn_is_enabled, spawn_position_strategy, spawn_min_wave, spawn_max_wave, spawn_interval, spawn_max_count_per_wave, spawn_single_count, spawn_single_variance, spawn_start_delay, spawn_weight, description) VALUES
    ('yuren', '鱼人', 'Unit', NULL, 'res://assets/Unit/Enemy/yuren/AnimatedSprite2D/yuren.tscn', 100.0, NULL, NULL, 2, -1.0, 2, 2, 1, 17.0, 150.0, 150.0, 1.0, NULL, NULL, 6.0, 1.0, 150.0, NULL, 6.0, 200.0, 1.0, 0.0, 0.0, 1, 200.0, 1, 'Rectangle', 1, -1, 2.0, -1, 3, 1, 0.0, 1, 'EnemyData.Yuren'),
    ('chailangren', '豺狼人', 'Unit', NULL, 'res://assets/Unit/Enemy/chailangren/AnimatedSprite2D/chailangren.tscn', 120.0, NULL, NULL, 5, -1.0, 2, 2, 1, 34.0, 100.0, 100.0, 3.0, NULL, NULL, 5.0, 1.0, 150.0, NULL, 5.0, 100.0, 1.0, 0.0, 0.0, 1, NULL, 1, 'Circle', 1, -1, 3.0, -1, 2, 0, 0.0, 1, 'EnemyData.Chailangren');
...
INSERT OR REPLACE INTO wave_definition(wave_id, display_name, wave_duration, reward_phase_seconds, completion_mode, next_wave_id, next_phase, reward_hook, shop_offer_set_id, description) VALUES
    ...
    (2, '第 2 波', 75.0, 0.25, 'DurationOrClear', NULL, 'Ended', 'shop_offer.validation', 'validation', '第二个普通玩法波次：继续开放式持续生成，证明 run flow 可以切换 wave catalog。');
...
INSERT OR REPLACE INTO wave_enemy_entry(wave_id, slot_index, enemy_id, position_strategy, spawn_interval, max_count, single_count, single_variance, start_delay, weight) VALUES
    (1, 0, 'chailangren', 'Circle', 1.2, -1, 1, 0, 0.0, 10),
    (1, 1, 'yuren', 'Rectangle', 1.6, -1, 1, 0, 0.4, 8),
    (2, 0, 'yuren', 'Rectangle', 1.0, -1, 1, 0, 0.0, 10),
    (2, 1, 'chailangren', 'Circle', 1.4, -1, 1, 0, 0.3, 8);
