...
INSERT OR REPLACE INTO resource_entry(category, resource_key, resource_path, description) VALUES
    ...
    ('Entity', 'EnemyEntity', 'res://Src/ECS/Base/Entity/Unit/Enemy/EnemyEntity.tscn', 'Legacy ResourcePaths.Entity_EnemyEntity'),
    ('Entity', 'LightningLineEffect', 'res://Src/ECS/Base/Entity/Effect/LightningLineEffect/LightningLineEffect.tscn', 'Legacy ResourcePaths.Entity_LightningLineEffect'),
    ('Entity', 'ProjectileEntity', 'res://Src/ECS/Base/Entity/Projectile/ProjectileEntity.tscn', 'Legacy ResourcePaths.Entity_ProjectileEntity'),
    ('Entity', 'TargetingIndicatorEntity', 'res://Src/ECS/Base/Entity/Unit/TargetingIndicator/TargetingIndicatorEntity.tscn', 'Legacy ResourcePaths.Entity_TargetingIndicatorEntity'),
    ('Entity', 'VisualPreviewEntity', 'res://Src/ECS/Base/Entity/Preview/VisualPreviewEntity.tscn', 'Legacy ResourcePaths.Entity_VisualPreviewEntity'),
    ('UI', 'ActiveSkillBarUI', 'res://Src/ECS/UI/UI/SkillUI/ActiveSkillBarUI.tscn', 'Legacy ResourcePaths.UI_ActiveSkillBarUI'),
    ('UI', 'ActiveSkillSlotUI', 'res://Src/ECS/UI/UI/SkillUI/ActiveSkillSlotUI.tscn', 'Legacy ResourcePaths.UI_ActiveSkillSlotUI'),
    ('UI', 'DamageNumberUI', 'res://Src/ECS/UI/UI/DamageNumberUI/DamageNumberUI.tscn', 'Legacy ResourcePaths.UI_DamageNumberUI'),
    ('UI', 'HealthBarUI', 'res://Src/ECS/UI/UI/HealthBarUI.tscn', 'Legacy ResourcePaths.UI_HealthBarUI'),
    ('UI', 'UIManager', 'res://Src/ECS/UI/Core/UIManager.tscn', 'Legacy ResourcePaths.UI_UIManager'),
    ('Asset', 'Unit.Player.Bubing.Visual', 'res://assets/Unit/Player/bubing/AnimatedSprite2D/bubing.tscn', 'Legacy ResourcePaths.AssetUnitPlayer_bubing'),
    ('Asset', 'Unit.Player.Guangfa.Visual', 'res://assets/Unit/Player/guangfa/AnimatedSprite2D/guangfa.tscn', 'Legacy ResourcePaths.AssetUnitPlayer_guangfa'),
    ('Asset', 'Projectile.LaserBolt', 'res://assets/Projectile/Projectile/Line2D/LaserBolt.tscn', 'Legacy ResourcePaths.AssetProjectile_LaserBolt'),
    ('System', 'DamageService', 'res://Src/ECS/Base/System/DamageSystem/DamageService.tscn', 'Legacy ResourcePaths.System_DamageService'),
    ('System', 'DamageStatisticsSystem', 'res://Src/ECS/Base/System/DamageSystem/DamageStatisticsSystem.tscn', 'Legacy ResourcePaths.System_DamageStatisticsSystem'),
    ('System', 'MouseSelectionSystem', 'res://Src/ECS/Base/System/MouseSelection/MouseSelectionSystem.tscn', 'Legacy ResourcePaths.System_MouseSelectionSystem'),
    ('System', 'PauseMenuSystem', 'res://Src/ECS/Base/System/PauseMenu/PauseMenuSystem.tscn', 'Legacy ResourcePaths.System_PauseMenuSystem'),
    ('System', 'RecoverySystem', 'res://Src/ECS/Base/System/RecoverySystem/RecoverySystem.tscn', 'Legacy ResourcePaths.System_RecoverySystem'),
    ('System', 'SpawnSystem', 'res://Src/ECS/Base/System/Spawn/SpawnSystem.tscn', 'Legacy ResourcePaths.System_SpawnSystem'),
    ('System', 'TestSystem', 'res://Src/ECS/Base/System/TestSystem/TestSystem.tscn', 'Legacy ResourcePaths.System_TestSystem'),
    ('Tools', 'ObjectPoolInit', 'res://Src/ECS/Tools/ObjectPool/ObjectPoolInit.tscn', 'Legacy ResourcePaths.Tools_ObjectPoolInit'),
    ('Tools', 'TimerManager', 'res://Src/ECS/Tools/Timer/TimerManager.tscn', 'Legacy ResourcePaths.Tools_TimerManager'),
    ('Data', 'Ability.ChainLightningConfig', 'res://Data/Data/Ability/Ability/ChainLightning/Data/ChainLightningConfig.tres', 'Legacy ResourcePaths.DataAbility_ChainLightningConfig'),
    ('Data', 'Unit.TargetingIndicatorConfig', 'res://Data/Data/Unit/Targeting/Resource/TargetingIndicatorConfig.tres', 'Legacy ResourcePaths.DataUnit_TargetingIndicatorConfig'),
    ('Config', 'System.DefaultPreset', 'res://Data/Config/System/Preset/Resource/DefaultPreset.tres', 'Legacy ResourcePaths.ConfigSystemPreset_DefaultPreset'),
    ('Config', 'System.SpawnSystem', 'res://Data/Config/System/System/Resource/SpawnSystem.tres', 'Legacy ResourcePaths.ConfigSystem_SpawnSystem');
